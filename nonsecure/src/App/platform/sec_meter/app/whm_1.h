...
#define TAMPER_DET_BITS_THISMONTH (MAGNET_DETED_BIT_THISMONTH)

#define IS_MAGNET_DETED_THISMONTH (0)
#define IS_COVEROPEN_DETED_THISMONTH (0)
#define IS_TEMPOVER_DETED_THISMONTH (0)
#define IS_RELAYERR_DETED_THISMONTH (0)
#define IS_MorTCOVER_OPEN_THISMONTH (0)

#define IS_MCOVER_OPEN ((tamper_det_bit & MCOVEROPEN_DETED_BIT) != 0)
#define IS_TCOVER_OPEN ((tamper_det_bit & TCOVEROPEN_DETED_BIT) != 0)
#define IS_MorTCOVER_OPEN ((tamper_det_bit & TCOVEROPEN_DETED_BIT) != 0)
